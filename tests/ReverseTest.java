...
public class ReverseTest {
    private static class ReverseTester extends MainTester<Void, int[][], int[][]> {
        public ReverseTester() throws ClassNotFoundException, NoSuchMethodException {
            super("Reverse");
        }
    ...
    public static void main(final String[] args) throws Exception {
        final ReverseTester tester = new ReverseTester();
